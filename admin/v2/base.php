                    ...
                    <div class="grid_12">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li><a href="cadastro.php">Cadastrar Email</a></li>
                                <li><a href="remover.php">Remover Email</a></li>
                                <li id="current"><a href="nova-campanha.php">Criar Campanha</a></li>
                                <li><a href="usuarios.php">Usuários Cadastrados</a></li>
                            </ul>
                        </div><!-- End. #Logo -->
                    </div><!-- End. .grid_12-->
                    <div style="clear: both;"></div>
		...
		<div class="container_12">
            ...
            <div class="grid_7">
            	<a href="" class="dashboard-module">
                	<img src="img/Crystal_Clear_write.gif" width="64" height="64" alt="edit" />
                ...
                <a href="" class="dashboard-module">
                	<img src="img/Crystal_Clear_files.gif" width="64" height="64" alt="edit" />
                	<span>Remover Usuário</span>
                </a>
                                
                <a href="" class="dashboard-module">
                	<img src="img/Crystal_Clear_user.gif" width="64" height="64" alt="edit" />
            ...
            <div class="grid_5">
                <div class="module">
                        <h2><span>Última Campanha</span></h2>
                        
                        <div class="module-body">
                        
                        	<p>
                                <strong>Administrador: </strong>Emerson Thompson<br />
                                <strong>Data: </strong>19 de Setembro 2013<br />
                                <strong>IP: </strong>000.000.00.00
                            </p>
                        
                             <div>
                                 <div class="indicator">
                                     <div style="width: 100%;"></div><!-- change the width value (23%) to dynamically control your indicator -->
                                 </div>
                                 <p>Enviado para: 100 de 100 Cadastrados</p>
                             </div>
                             
                             <div>
                                 <div class="indicator">
                                     <div style="width: 85%;"></div><!-- change the width value (100%) to dynamically control your indicator -->
                                 </div>
                                 <p>Emails Alcançados: 85 de 100 Enviados</p>
                             </div>
            ...
            <div class="grid_12">
                ...
                <div class="bottom-spacing">
                    ...
                    <div class="float-right">
                        <a href="" class="button">
                        	<span>New Article <img src="img/plus-small.gif" width="12" height="9" alt="New article" /></span>
                        </a>
                    </div>
                ...
                <div class="module">
                    ...
                    <div class="module-table-body">
                        ...
                        <table id="myTable" class="tablesorter">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                    	<input type="checkbox" />
                                        <a href=""><img src="img/tick-circle.gif" width="16" height="16" alt="published" /></a>
                                        <a href=""><img src="img/pencil.gif" width="16" height="16" alt="edit" /></a>
                                        <a href=""><img src="img/balloon.gif" width="16" height="16" alt="comments" /></a>
                                        <a href=""><img src="img/bin.gif" width="16" height="16" alt="delete" /></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                    	<input type="checkbox" />
                                        <a href=""><img src="img/minus-circle.gif" width="16" height="16" alt="not published" /></a>
                                        <a href=""><img src="img/pencil.gif" width="16" height="16" alt="edit" /></a>
                                        <a href=""><img src="img/balloon.gif" width="16" height="16" alt="comments" /></a>
                                        <a href=""><img src="img/bin.gif" width="16" height="16" alt="delete" /></a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<input type="checkbox" />
                                        <a href=""><img src="img/minus-circle.gif" width="16" height="16" alt="published" /></a>
                                        <a href=""><img src="img/pencil.gif" width="16" height="16" alt="edit" /></a>
                                        <a href=""><img src="img/balloon.gif" width="16" height="16" alt="comments" /></a>
                                        <a href=""><img src="img/bin.gif" width="16" height="16" alt="delete" /></a>
                                    </td>
                     ...
                     <div class="pagination">           
                		<a href="" class="button"><span><img src="img/arrow-stop-180-small.gif" height="9" width="12" alt="First" /> First</span></a> 
                        <a href="" class="button"><span><img src="img/arrow-180-small.gif" height="9" width="12" alt="Previous" /> Prev</span></a>
                        <div class="numbers">
                            <span>Page:</span> 
                            <a href="">1</a> 
                            <span>|</span> 
                        ...
                        <a href="" class="button"><span>Next <img src="img/arrow-000-small.gif" height="9" width="12" alt="Next" /></span></a> 
                        <a href="" class="button last"><span>Last <img src="img/arrow-stop-000-small.gif" height="9" width="12" alt="Last" /></span></a>
                        <div style="clear: both;"></div> 
                     </div>
