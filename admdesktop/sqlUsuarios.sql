...
INSERT INTO `modulos` (`id`, `modulo`,`descricao`) VALUES 
 ...
 (1, 'tb_anunciante',	'Tb_Anunciante'),
 
 (2, 'tb_clientes',	'Tb_Clientes'),
 
 (3, 'tb_fornecedor',	'Tb_Fornecedor'),
 
 (4, 'tb_tipo_anuncio',	'Tb_Tipo_Anuncio'),
...
INSERT INTO `modulos_acoes` (`acao`,`modulo_id`, `acao_desc`) VALUES 
 ...
 ('editar', 	5, 'Editar'),
 ('deletar', 	5, 'Deletar'),
 ('modulos',	5,	'Add. Modulos'),
 
 ('listar', 	6, 'Listar'),
 ('adicionar', 	6, 'Adicionar'),
 ('editar', 	6, 'Editar'),
 ('deletar', 	6, 'Deletar'),
 ('modulos',	6,	'Add. Modulos');
